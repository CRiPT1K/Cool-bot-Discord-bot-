    ...
    if (message.substring(0, 1) == '*') {
        ...
        switch(cmd) {  
			case 'help':
                bot.sendMessage({
                    to: channelID,
                    message: 'Commands: *gay , *dab, *meme, *normieMeme, *copyPasta'
               });
            break
